        ...
        m_invokeManager(new InvokeManager(this))
{
    ...
    m_notify->setTitle("TheRipper Service");
    m_notify->setBody("TheRipper service requires attention");

    bb::system::InvokeRequest request;
    request.setTarget("chachkouski.TheRipper");
...
{
    if (request.action().compare("chachkouski.TheRipperService.RESET") == 0) {
        triggerNotification();
    }
}
